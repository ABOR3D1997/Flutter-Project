...
import 'package:flutter_apotheke/assets/constants.dart';
...
import 'package:flutter_apotheke/providers/boxes.dart';
...
class AddDateColumn extends StatefulWidget {
  ...
  final String date;
  const AddDateColumn({Key key,  this.dateText,  this.date})
      : super(key: key);
...
class TimePicker extends StatefulWidget {
  ...
  const TimePicker({Key key,  this.dateText,  this.timeInfo}) : super(key: key);
